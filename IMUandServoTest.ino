...
Servo aileron; //create servo object to control servo
...
void setup(void)
{
  aileron.attach(9); //attaches the servo to pin 9
  Serial.begin(9600);
  Serial.println("Orientation Sensor Test"); Serial.println("");
  pinMode(switchPin, INPUT);
  pinMode(rxAileronPin, INPUT);
...
void loop(void)
{
  ...
  if (duration > 1500) {
    ...
    //Serial.print(" - ");
    Serial.println(rxAileronPass);
    aileron.write(rxAileronPass);
  }
  else {
